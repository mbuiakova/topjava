...
<section>
    ...
    <form method="get" action="filterMeal">
        <dl>
    ...
    <hr/>
    <a href="createOrUpdateMeal"><spring:message code="meal.addMeal"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="createOrUpdateMeal?id=${meal.id}"><spring:message code="meal.update"/></a></td>
                <td><a href="deleteMeal?id=${meal.id}"><spring:message code="meal.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
